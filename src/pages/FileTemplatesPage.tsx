    ...
    <div className="w-full px-6 md:px-10 lg:px-16 py-10">
      ...
      {loading ? (
        ...
        <div className="mt-16 text-center text-slate-500 bg-white border border-dashed border-slate-300 rounded-xl py-16">
          No file templates yet for this tenant. Register one via <code className="font-mono text-xs bg-slate-100 px-1.5 py-0.5 rounded">POST /api/tenants/{tenantId}/file-templates/upload</code>.
        </div>
      ) : (
